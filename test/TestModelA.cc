...
class TestModelA : public hls4mlEmulator::Model {
private:
...
public:
  TestModelA() : inputs_{0, 0, 0}, output_{0} {}

  virtual ~TestModelA() = default;
...
extern "C" hls4mlEmulator::Model* create_model() { return new TestModelA; }
